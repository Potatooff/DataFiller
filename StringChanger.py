...
def get_response(input_text,num_return_sequences,num_beams):  
  ...
  translated = model.generate(**batch,max_length=150,num_beams=num_beams, num_return_sequences=num_return_sequences, temperature=1.5)  # temperature is if you want the bot to be more create set it more than 5 else dont change
